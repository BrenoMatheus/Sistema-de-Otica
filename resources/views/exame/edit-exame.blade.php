        ...
        <form action="/exame/update/{{$exame->id}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body ">         
                <!-- longe -->
                    ...
                    <div class="col-2">
                        <input type="date" class="form-control fw-bold" placeholder="Data" name="data" id="data" value="{{ $exame->data->format('Y-m-d') }}" required>  
                    </div>
                    </div>
                    ...
                    <div class="row row-cols-6 g-0">
                        ...
                        <div class="col">
                            <input type="text" class="p-1 border form-control" name="dir_longe[]" value="{{$dl}}" required>
                        </div>
                        @endforeach
                        <!-- //EL -->
                        <div class="col">
                        ...
                        <div class="col">
                            <input type="text" class="p-1 border form-control" name="esq_longe[]" value="{{$el}}" required>
                        </div>
                        @endforeach
                    </div>
                    </div>
                    ...
                    <div class="row row-cols-6 g-0">
                        ...
                        <div class="col">
                            <input type="text" class="p-1 border form-control" name="dir_perto[]" value="{{$dp}}" required>
                        </div>
                        @endforeach
                        <!-- // -->
                        <div class="col">
                        ...
                        <div class="col">
                            <input type="text" class="p-1 border form-control" name="esq_perto[]" value="{{$ep}}" required>
                        </div>
                        @endforeach   
                    </div>
                    </div>
