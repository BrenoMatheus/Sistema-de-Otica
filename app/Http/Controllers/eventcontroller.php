...
class eventcontroller extends Controller
{
    ...
    public function create(){
        ...
        return view('events.create', ['$pacients' => $pacients]);
    }
    ...
    public function destroy($id){
        ...
        return redirect('/dashboard')->with('msg', 'Events destroy with succely!');
    }
    ...
    public function update(Request $request){
        ...
        return redirect('/dashboard')->with('msg', 'Events update with succely!');
    }
